...
{
    public class Ev2ResourceTypeProvider : IResourceTypeProvider
    {
        ...
        private readonly Ev2ResourceTypeLoader resourceTypeLoader;
        ...
        public Ev2ResourceTypeProvider(Ev2ResourceTypeLoader resourceTypeLoader)
        {
